    ...
    <div id="body-center">
        ...
        <div id="vista-previa-container" style="display: inline-flex;">
            <div id="input-añadir-libro">
                ...
                <!---->
                <form action=""><button disabled id="cancelar" style="border: #7c7c7c solid 2px; margin-right: 2rem;"><a href="../home/index.php" style="color: #686767;">CANCELAR</a></button></form>
