            ...
            <div id="body-center">
                ...
                <table id="body-header-static" cellspacing="0" cellpadding="15" >
                    ...
                    <tr id="body-header-static1" style="color:black; font-weight: bold; font-size:17px; height: 5.4rem; ">
                        ...
                        <td class="td-inv" style="text-align: center;"><?php echo $libros['id_cat']?></td>
                        <td class="td-inv" style="text-align: center;"><?php echo $libros['stock_book']?></td>
                        <td class="td-inv" style="text-align: center;"><p id="vendidoslibro">3</p></td></td>
                        <td><button id="btn-vendido" style="border:none;" class="btns-center">Vendido!</button></td>
                        <td><button id="btn-modificar" class="btns-center"><a href="..\CRUD\modificar.php?codBook=<?php echo $libros['id_books']; ?>&x=" style="text-decoration: none; color: black; ">Modificar </a></button></td>
                        <td><button id="btn-eliminar" class="btns-center"><a  href="..\CRUD\eliminar.php?codBook=<?php echo $libros['id_books'];?>&x=" style="text-decoration: none; color:white;">Eliminar</a></button> </td>
                    </tr><?php } ?>
                </table>
